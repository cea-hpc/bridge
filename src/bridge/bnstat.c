...
/*!
 * \brief display batch node information on file stream in an extended form 
 * \internal
 *
...
/*!
 * \brief display batch node information on file stream in an classic form 
 * \internal
 *
 * \param stream FILE* on which to write output
 * \param bq pointer on a batch node structure to display
...
/*!
 * \brief display required information about batch node on file stream 
 * \internal
 *
 * \param stream FILE* on which to write output
 * \param bq pointer on a batch node structure to display
