...
int main(int argc,char** argv){
  ...
  char* fields_list="\n"
    ...
    "\tstate         : Status of allocation                        reason        : More information about status\n"
  ...
  char* options_desc=
    ...
    "\t-i\t\t\tDisplay information about non-batch allocations only\n"
    "\t-I\t\t\tDisplay information about batch allocations only\n"
    "\t-r resid\t\tDisplay information of a allocation giving its id\n"
